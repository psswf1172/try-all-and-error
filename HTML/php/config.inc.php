...
$config['send_to']				= 'jennifermabella@gmail.com';			// destination of all emails sent throught contact form

// Email Subject
$config['subject']				= 'Email from your personal website!';			// subject of emails you receive
?>